  ...
  return (
    <section className="relative min-h-screen flex flex-col overflow-hidden">
      ...
      >
        ...
        <motion.div variants={item}>
          <div className="liquid-glass rounded-full px-4 py-1.5 mb-8 inline-flex items-center gap-2">
            ...
            <span className="bg-primary/10 text-primary text-xs font-medium px-2 py-0.5 rounded-full flex items-center gap-1">
              Live on Testnet <ChevronRight className="w-3 h-3" />
            </span>
          </div>
        </motion.div>
        ...
        >
          Bet on real-world outcomes with fully encrypted positions. Your bet amount and direction are invisible on-chain — powered by Fully Homomorphic Encryption.
        </motion.p>
